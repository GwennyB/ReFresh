    ...
    public class ReFreshDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { ID = 8, Sku = 8, Name = "Chips and Dip", Description = "Serves One, because who wants to share this amazing appetizer. With just enough for you this Chips and Dip package is perfect for any couch adventure.", Image = "ChipsDip.jpg", Price = 3, Category = Categories.snacks, Meaty = false, QtyAvail = 5 },
